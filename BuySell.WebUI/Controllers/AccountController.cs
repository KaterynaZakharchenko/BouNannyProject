    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var RegsitrationResult = RegisterAClient(user);
                    ...
                    //Assign Default Client Role to user Here      
        ...
        private bool RegisterAClient(ApplicationUser user)
        {
            IRepositoryBase<Client> Clients = new ClientsRepository(new DataContext());
            ...
            client.StateID = user.StateID;
            client.CityID = user.CityID;
            client.MobileNumber = user.MobileNumber;
